...
public class PruebaOrdena3 {
    ...
    public static void main(String[] args) {
        ...
        int[] tamanos = {
         ...
         try (BufferedWriter writer = new BufferedWriter(new FileWriter("resultados_ordenacion333.csv"))) {
            ...
            for (int tam : tamanos) {
                ...
                for (int k = 0; k < repeticiones; k++) {
                    ...
                    Ordena3.resetContadores();  // Reiniciar contadores

                    long inicio = System.nanoTime();  // Empezar a contar el tiempo
                    Ordena3.ordena3(v, tam);  // Ejecutar el algoritmo
                    long fin = System.nanoTime();  // Tiempo de finalización

                    tiempoTotal += (fin - inicio);  // Acumular el tiempo
                    comparacionesTotal += Ordena3.getComparaciones();  // Acumular comparaciones
                    asignacionesTotal += Ordena3.getAsignaciones();  // Acumular asignaciones
                }
