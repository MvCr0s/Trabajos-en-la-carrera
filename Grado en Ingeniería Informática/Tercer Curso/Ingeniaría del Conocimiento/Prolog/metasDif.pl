...
dsolve_traza2(true,D,D):-!.
dsolve_traza2((A,B),D1,D2):-!,dsolve_traza2(A,D1,D3), dsolve_traza2(B,D3,D2).
dsolve_traza2(A,D,D):-delay(A), member(A,D),!.
dsolve_traza2(!,D,D):-!.
dsolve_traza2(A,D,[A|D]):-delay(A).
dsolve_traza2(A,D1,D2):-clause(A,B),dsolve_traza2(B,D1,D2).
