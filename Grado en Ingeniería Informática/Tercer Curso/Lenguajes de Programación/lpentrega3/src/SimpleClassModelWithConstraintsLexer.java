...
public class SimpleClassModelWithConstraintsLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"INT", "FLOAT_LITERAL", "STRING1_LITERAL", "STRING2_LITERAL", "ENUMERATION_LITERAL", 
			"NULL_LITERAL", "ID", "MULTILINE_COMMENT", "NEWLINE", "WS"
		};
	}
	...
	public SimpleClassModelWithConstraintsLexer(CharStream input) {
		super(input);
