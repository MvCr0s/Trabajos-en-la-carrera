 ...
 * ******************************************************** */
 ...
 final static String ChestStatus     = "ChestStatus";
 ...
 final static String DefaultChestStatus= StatusClosed;
 ...
 final static String DefaultDoorStatus  = StatusClosed;
              /* vuelve a cerrarse al salir del lugar */
 ...
 * ************************************** */
  ...
  final static int ThiefMaxHealthPower =  160;
  final static int ThiefMinHealthPower =  140;
  final static int ThiefFacHealthPower = 200; /* factor 1.0 */
  final static int ThiefMaxMagicPower  =  160;
  final static int ThiefMinMagicPower  =  140;
  final static int ThiefFacMagicPower  = 200; /* factor 1.0 */
  final static int ThiefAccessAbility  = 250;
  ...
  final static int WizardMaxHealthPower =  140;
  final static int WizardMinHealthPower =  120;
  final static int WizardFacHealthPower =  150;  /* factor 1/2 */
  final static int WizardMaxMagicPower  = 200;
  final static int WizardMinMagicPower  =  185;
  final static int WizardFacMagicPower  = 250; /* factor 3/2 */
  final static int WizardAccessAbility  = 200;
  ...
  final static int FighterMaxHealthPower = 200;
  final static int FighterMinHealthPower =  185;
  final static int FighterFacHealthPower = 250; /* factor 3/2 */
  final static int FighterMaxMagicPower  =  120;
  final static int FighterMinMagicPower  =  110;
  final static int FighterFacMagicPower  =  150; /* factor 1/2 */
  final static int FighterAccessAbility  = 200;
                           /* necesita todo el nivel para acceder */
}
