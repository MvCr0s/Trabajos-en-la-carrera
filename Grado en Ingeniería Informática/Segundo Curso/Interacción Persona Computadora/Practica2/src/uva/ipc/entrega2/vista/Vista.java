...
import uva.ipc.entrega2.modelo.Ruta1;
...
public class Vista extends javax.swing.JFrame {
    ...
    */
    ...
    private void initComponents() {
        ...
        recomenzarButton = new javax.swing.JButton();
        ...
        jPanel69.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 5));
        ...
        jPanel69.add(volver0Button, java.awt.BorderLayout.CENTER);

        jPanel46.add(jPanel69);

        jPanel71.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 5, 1, 1));
        ...
        jPanel71.add(continuarButton, java.awt.BorderLayout.CENTER);

        jPanel46.add(jPanel71);
        ...
        jPanel63.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 5));
        ...
        jPanel64.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 5, 1, 1));
        ...
        jPanel22.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 5));
        ...
        jPanel77.setBorder(javax.swing.BorderFactory.createEmptyBorder(5, 1, 5, 1));
        jPanel77.setLayout(new java.awt.BorderLayout());

        comprarOtroButton.setFont(new java.awt.Font("Segoe UI", 0, 36)); // NOI18N
        comprarOtroButton.setText("INICIO");
        ...
        jPanel78.setBorder(javax.swing.BorderFactory.createEmptyBorder(5, 1, 5, 1));
        jPanel78.setLayout(new java.awt.BorderLayout());

        recomenzarButton.setFont(new java.awt.Font("Segoe UI", 0, 36)); // NOI18N
        recomenzarButton.setText("COMPRAR OTRO BILLETE");
        recomenzarButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                recomenzarButtonActionPerformed(evt);
            }
        });
        jPanel78.add(recomenzarButton, java.awt.BorderLayout.CENTER);

        jPanel76.add(jPanel78);

        jPanel79.setBorder(javax.swing.BorderFactory.createEmptyBorder(5, 1, 1, 1));
        jPanel79.setLayout(new java.awt.BorderLayout());

        salirButton.setFont(new java.awt.Font("Segoe UI", 0, 36)); // NOI18N
    ...
    private void continuar2ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_continuar2ButtonActionPerformed
        if (!trenesList.isSelectionEmpty()) {
            // Obtener el elemento seleccionado del JList como un String
            String elementoSeleccionado = trenesList.getSelectedValue();
            // Dividir el elemento en sus partes utilizando el método split
            String[] partes = elementoSeleccionado.split(" ");

            // Acceder a cada parte individualmente
            miControlador.setIdRuta(partes[0]);
            miControlador.setDuracion(partes[1]);
            miControlador.setPrecio(partes[2]);
            miControlador.setHora(partes[3]);
    ...
    public void tarjetaAceptadaPin(){
        miControlador.procesarNumeroBilletes();
        jPanel3.setVisible(false);
        jPanel4.setVisible(true);
        salirButton.setVisible(true);
        comprarOtroButton.setVisible(true);
        recomenzarButton.setVisible(true);
        detallesTrayectoTextArea.setVisible(true);
        rellenarDetalles();
        if(miControlador.isEditando()){
            miControlador.cambiarBilleteEdicion();
        }
    }
    ...
    public void rellenarDetalles(){
       ...
       if(biciCheckBox.isSelected()){
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("villetes.csv", true))) {
            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
            String fechaFormateada = dateFormat.format(getfecha());
            System.out.println("fecha: "+fechaFormateada);
            
            String hora = miControlador.getHora();
            String estacionOrigen = origenComboBox.getSelectedItem().toString();
            String estacionDestino = destinoComboBox.getSelectedItem().toString();
            String duracion = miControlador.getDuracion(); 
            String coste = miControlador.getPrecio(); 

            // Escribir en el archivo CSV
            writer.write(String.format("%s;%s;%s;%s;%s;%s\n", fechaFormateada,hora ,estacionOrigen, estacionDestino, duracion, coste));
        } catch (IOException e) {
        }
    }
    ...
    private void continuarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_continuarButtonActionPerformed
        if(getOrigen().equals("Seleccione estación de origen") || getDestino().equals("Seleccione estación de destino") || getOrigen().equals(getDestino()) || miControlador.isFutureDate(fechaDateChooser.getDate())){
            error1Label.setForeground(Color.red);
            error1Label.setText(miControlador.getPrimerPasoError());
        }
        else{
            jPanel1.setVisible(false);
            jPanel2.setVisible(true);
            mascotaCheckBox.setEnabled(true);
            biciCheckBox.setEnabled(true);
            volverButton.setEnabled(true);
            trenesList.setEnabled(true);
            miControlador.listaDeTrenes();
            continuar2Button.setEnabled(true);
            error1Label.setEnabled(false);
    ...
    private void recomenzarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recomenzarButtonActionPerformed
        main.getGestorVistas().mostrarVista5();
    }//GEN-LAST:event_recomenzarButtonActionPerformed
    ...
    private void invisibilicecomponents(){
        ...
        recomenzarButton.setVisible(false);
    ...
    private void inicializarComboBoxes() {    
        if(!miControlador.isEditando())  {
            ...
            origenComboBox.setSelectedItem(miControlador.getBillete().getOrigen());
            destinoComboBox.setSelectedItem(miControlador.getBillete().getDestino());
            LocalDate fechaEdit= miControlador.getBillete().getFecha();
            Date fechaEditDate = java.sql.Date.valueOf(fechaEdit);
            fechaDateChooser.setDate( fechaEditDate);
        }
    }
    ...
    private javax.swing.JButton recomenzarButton;
